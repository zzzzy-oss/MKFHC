...
if __name__ == '__main__':
    ...
    if args.lm_type == "gemma":
        ...
        model = AutoModelForCausalLM.from_pretrained("../pre/Llama3-8b/LLM-Research/Meta-Llama-3-8B-Instruct")
        tokenizer = AutoTokenizer.from_pretrained("../pre/Llama3-8b/LLM-Research/Meta-Llama-3-8B-Instruct")
    else:
        raise ValueError
    model = model.cuda()
